...
document.querySelectorAll('.food-category button').forEach(button => {
    button.addEventListener('click', () => {
        ...
        // Show/Hide food items based on selected category
        document.querySelectorAll('.food-item').forEach(item => {
            if (foodType === 'all' || item.classList.contains(`${foodType}-type`)) {
...
// Initial state: Show all food items
document.querySelectorAll('.food-item').forEach(item => item.style.display = 'block');
